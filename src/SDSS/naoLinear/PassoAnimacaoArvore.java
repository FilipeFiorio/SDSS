 ...
 * @author filipe
 */
//classe praticamente igual a PassoAnimacao para lineares, essa recebe um node e valores do centro do node, poderia
//apenas adaptar aquela classe
public class PassoAnimacaoArvore {
    ...
    public PassoAnimacaoArvore(Node node, double centroXIni, double centroYIni, double centroXFim, double centroYFim, double tempoTotal) {
        this.node = node;
